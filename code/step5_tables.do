...
* Output : output/tables/table_[des].xls
*          output/tables/table_[des].tex
...
* esttab using "$OUTPUT_TABLES/table_summary_stats.tex", ///
...
* esttab m1 m2 using "$OUTPUT_TABLES/table_baseline_reg.tex", ///
*     label star(* 0.1 ** 0.05 *** 0.01) b(3) se(3) ar2 replace

* esttab m1 m2 using "$OUTPUT_TABLES/table_baseline_reg.xls", ///
*     label star(* 0.1 ** 0.05 *** 0.01) b(3) se(3) ar2 replace
